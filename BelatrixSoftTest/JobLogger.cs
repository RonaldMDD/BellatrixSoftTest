...
namespace BelatrixSoftTest
{
    public class JobLogger
    {
        ...
        public static void LogMessage(string message, bool messageb, bool warning, bool error) 
        { 
            message.Trim(); 
            ...
            if ((!_logError && !_logMessage && !_logWarning) || (!messageb && !warning && !error)) 
            { 
